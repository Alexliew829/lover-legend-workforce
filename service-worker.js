const CACHE_NAME = "ll-workforce-v192";
...
const APP_SHELL = [
  ...
  "./css/style.css?v=1.92",

  "./js/config.js?v=1.92",
  "./js/app.js?v=1.92",
  "./js/api.js?v=1.92",
  "./js/format.js?v=1.92",
  "./js/dashboard.js?v=1.92",
  "./js/worker.js?v=1.92",
  "./js/advance.js?v=1.92",
  "./js/payroll.js?v=1.92",
  "./js/payslip.js?v=1.92",

  "./assets/lover-legend-green.png",
  "./assets/lover-legend-red.jpg",
  "./assets/icons/apple-touch-icon.png?v=1.92",
  "./assets/icons/favicon.ico?v=1.92",
  "./assets/icons/icon-32.png?v=1.92",
  "./assets/icons/icon-180.png?v=1.92",
  "./assets/icons/icon-192.png?v=1.92",
  "./assets/icons/icon-256.png?v=1.92",
  "./assets/icons/icon-512.png?v=1.92",
  "./assets/icons/maskable-icon-512.png?v=1.92"
];
