const CACHE_NAME = "ll-workforce-v242";
...
const APP_SHELL = [
  ...
  "./css/style.css?v=2.4.2",

  "./js/config.js?v=2.4.2",
  "./js/app.js?v=2.4.2",
  "./js/api.js?v=2.4.2",
  "./js/format.js?v=2.4.2",
  "./js/dashboard.js?v=2.4.2",
  "./js/worker.js?v=2.4.2",
  "./js/advance.js?v=2.4.2",
  "./js/payroll.js?v=2.4.2",
  "./js/payslip.js?v=2.4.2",

  "./assets/lover-legend-green.png",
  "./assets/lover-legend-red.jpg",
  "./assets/icons/apple-touch-icon.png?v=2.4.2",
  "./assets/icons/favicon.ico?v=2.4.2",
  "./assets/icons/icon-32.png?v=2.4.2",
  "./assets/icons/icon-180.png?v=2.4.2",
  "./assets/icons/icon-192.png?v=2.4.2",
  "./assets/icons/icon-256.png?v=2.4.2",
  "./assets/icons/icon-512.png?v=2.4.2",
  "./assets/icons/maskable-icon-512.png?v=2.4.2"
];
